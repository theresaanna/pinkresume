    ...
    <main className="grid">
      <div className="main">
        ...
        <div className="letter">
          ...
          <p>In addition to being thorough in this way, I am flexible. <strong>I have learned tons of frameworks, libraries, and language features over the years.</strong> Given a bit of time to study, I can tackle anything new, bringing fresh eyes married with the wisdom of best practices. I started out using obscure early <a href="https://www.php.net/">PHP</a> blogging platforms and then moved to <a href="https://wordpress.com/">Wordpress</a>, to <a href="https://new.drupal.org/home">Drupal</a>, had a brief stint in Ruby on Rails, onto more bespoke solutions using <a href="https://www.python.org/">Python</a> and have landed, most recently, at <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript">JavaScript</a>. Within <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript">JavaScript</a> alone I have learned frameworks all the way from <a href="https://jquery.com/">jQuery</a> to the <a href="https://backbonejs.org/">Backbone.js</a>/<a href="https://underscorejs.org/">Underscore.js</a> days, up through the ES6, <a href="https://react.dev/">React</a> and Node ecosystems.</p>
