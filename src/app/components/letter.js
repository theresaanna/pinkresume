 ...
 const AnimatedParagraphs = () => {
 	const [hasScrolled, setHasScrolled] = useState(false);
  	...
  	const paragraphs = [
        ...
        <>I can code. Without AI. I've been making the internet, as I say, since the late 1990s. I am always working on adding to a <a href="https://github.com/theresaanna/leetcode">Github repository of Leetcode exercises</a> to demonstrate some of my ability. Please take a look.</>,
