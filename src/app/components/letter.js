 ...
 const AnimatedParagraphs = () => {
 	const [hasScrolled, setHasScrolled] = useState(false);
  	...
  	const paragraphs = [
        ...
        <>I am always working on adding to a <a href="https://github.com/theresaanna/leetcode">Github repository of Leetcode exercises</a> to demonstrate some of my ability. Please take a look.</>,
	<>Since working for the government, I have taken <strong>various classes on computer science</strong> material. I am currently attending a certification course at Johns Hopkins University Whiting School of Engineering in Generative AI. I answer other students’ questions for my teachers in the class chat when the teacher misses it. I ask for additional work to be unlocked in the learning platform early for me to complete.</>,
	<>I am raring to go. Unleash me on your organization. <strong>I am who you bring in when you want gentle disruption.</strong> When you want someone to ask the hard questions. When you want an engineer that values cross disciplinary collaboration. I put my all into doing everything I do. I insist on doing things to a high degree of excellence.</>,
	<>As an engineering manager, I worked to create a safe and empowering space for my engineers. <strong>I fought for higher performance bonuses, mentored engineers into management positions themselves.</strong> I bring a sharp, analytical mind with a heart of gold, someone that creates such deep bonds naturally that I am good friends with so many colleagues to this day. I put my all into my work, head and heart.</>,
