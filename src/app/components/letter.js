 ...
 const AnimatedParagraphs = () => {
 	const [hasScrolled, setHasScrolled] = useState(false);
  	...
  	const paragraphs = [
        ...
        <>I can code completely indepenent of AI. I have been making the internet, as I say, since the late 1990s. I am always working on adding to a <a href="https://github.com/theresaanna/leetcode">Github repository of Leetcode exercises</a> to demonstrate some of my ability. Please take a look.</>,
	...
	<>As an engineering manager, I worked to create a safe and empowering space for my engineers. <strong>I fought for higher performance bonuses, mentored engineers into management positions themselves.</strong> I bring a sharp, analytical mind paired with keen emotional intelligence. I am someone that creates such deep bonds naturally that I am good friends with many colleagues to this day. I put my all into my work, head and heart.</>,
